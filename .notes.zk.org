...
** DONE Clojure intro for home page
...
** TODO switch code and copy
** DONE disable input until js loads
** TODO reduce size of ac entries (fit more)
** TODO Add puppet labs to who uses clojure
